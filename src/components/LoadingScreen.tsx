  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      tl.to(
        ...
        { opacity: 1, duration: 0.001, stagger: 0.07 },
        0.1,
      );
      ...
      tl.from(
        creditRef.current,
        { autoAlpha: 0, y: 7, duration: 0.6, ease: "power2.out" },
        "p+=0.9",
      );
  ...
  return (
    ...
    >
      ...
      {[
        ...
        <div
          key={id}
          className={`corner absolute w-6 h-6 opacity-0 ${cls}`}
      ...
      <div className="relative z-10 flex flex-col items-center w-full px-6">
        ...
        <div
          ref={lineTopRef}
          className="mb-10 md:mb-14 h-px w-24 md:w-36"
          style={{ background: "rgba(184,147,90,0.5)" }}
        />

        {/* KAD letters */}
        <div
          className="flex items-end justify-center gap-0 overflow-hidden"
          style={{
            height: "clamp(4.2rem, 11vw, 8.5rem)",
        ...
        <div
          ref={lineBottomRef}
          className="mb-7 md:mb-9 h-px w-24 md:w-36"
          style={{ background: "rgba(184,147,90,0.5)" }}
        />
      ...
      >
        <div
          ...
          style={{
            background:
              "linear-gradient(90deg, rgba(184,147,90,0.25), rgba(184,147,90,0.85))",
